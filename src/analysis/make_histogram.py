...
def main(args):
    ...
    # min_freq = np.min(histogram)
    # extract = extract if extract < min_freq else min_freq

    # class_list = [
    #     random.sample(class_0, extract),
    #     random.sample(class_1, extract),
    #     random.sample(class_2, extract),
    #     random.sample(class_3, extract)
    # ]
