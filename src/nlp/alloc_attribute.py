...
class AttributeAllocation:
    ...
    def alloc_attribute(self, sentence: str) -> list:
        ...
        word_list = [
            ...
            if not word.word in self.intersection_words and not word.surface in self.intersection_words
        ]
        ...
        # pprint(word_attribute_list, indent=2)
        # print()
        ...
        sentence_attribute_list = sorted(
            sentence_attribute_list,
